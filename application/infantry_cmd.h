...
#define CMD_PUSH_CHASSIS_IMU                (0x0206u)
struct cmd_imu_info
{
    float gx;
    float gy;
...
#define CMD_PUSH_CHASSIS_STATE (0x0207u)
struct cmd_chassis_state {
    float gz;
};

#define CMD_PUSH_CHASSIS_BATTERY (0x0208u)
struct cmd_battery_info {
    float voltage;
};
...
#define CMD_PUSH_GIMBAL_IMU                 (0x0306u)
#define CMD_PUSH_GIMBAL_BATTERY (0x0308u)
